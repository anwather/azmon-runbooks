# SQL Server — Availability group is not online

**Alert ID:** `sql-ag-online`
**Severity:** 2 Error
**Category:** AlwaysOn
**Detection mechanism:** DMV probe
**Source SCOM monitor / rule (if any):** `Monitor.AvailabilityGroupHealth.AvailabilityGroupOnline`

---

## Symptom

The availability group online/recovery health policy is unhealthy.

## What it means

The AG is not fully online from the primary perspective. Databases may be unavailable, resolving, or unable to accept data movement.
