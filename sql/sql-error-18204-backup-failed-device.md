# SQL Server — SQL error 18204 backup device failed

**Alert ID:** `sql-error-18204-backup-failed-device`
**Severity:** 2 Error
**Category:** ERRORLOG
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.Backup_device_failed___Operating_system_error_1_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 18204. Typical message text: "BackupDiskFile::CreateMedia: Backup device failed to create or open. Operating system error."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-18204-database-engine-error
