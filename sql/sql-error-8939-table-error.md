# SQL Server — SQL error 8939 table/index consistency error

**Alert ID:** `sql-error-8939-table-error`
**Severity:** 1 Critical
**Category:** ERRORLOG
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.Table_error_8939_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 8939. Typical message text: "Table error: object ID, index ID, partition ID, allocation unit ID has consistency errors."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-8939-database-engine-error
