# SQL Server — AG replicas data synchronization is unhealthy

**Alert ID:** `sql-ag-replicas-data-sync`
**Severity:** 3 Warning
**Category:** AlwaysOn
**Detection mechanism:** DMV probe
**Source SCOM monitor / rule (if any):** `Monitor.AvailabilityGroupHealth.AvailabilityReplicasSynchronizing`

---

## Symptom

One or more AG replicas are not in the expected synchronization state.

## What it means

Data movement is delayed or suspended for at least one replica/database. RPO increases and secondary reads may be stale.
