# SQL Server — SQL error 18210 backup device I/O failed

**Alert ID:** `sql-error-18210-backup-failed-device-other`
**Severity:** 2 Error
**Category:** ERRORLOG
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.BackupIoRequest_1_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 18210. Typical message text: "BackupMedium::ReportIoError: write/read failure on backup device. Operating system error."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-18210-database-engine-error
