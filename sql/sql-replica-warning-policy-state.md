# SQL Server — Availability replica user policy warning

**Alert ID:** `sql-replica-warning-policy-state`
**Severity:** 3 Warning
**Category:** AlwaysOn
**Detection mechanism:** DMV probe
**Source SCOM monitor / rule (if any):** `Monitor.AvailabilityReplicaWarningPolicy.State`

---

## Symptom

A custom PBM policy for an availability replica evaluated to warning.

## What it means

The customer-defined replica warning policy has failed. Use PBM history to identify the failed condition.
