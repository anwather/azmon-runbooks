# SQL Server — SQL error 1418 mirroring endpoint cannot be reached

**Alert ID:** `sql-error-1418-mirroring-endpoint`
**Severity:** 2 Error
**Category:** AlwaysOn
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.Database_mirroring_login_attempt_failed_1_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 1418. Typical message text: "The server network address cannot be reached or does not exist for database mirroring or AlwaysOn endpoint connection."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-1418-database-engine-error
