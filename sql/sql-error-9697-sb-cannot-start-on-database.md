# SQL Server — SQL error 9697 Service Broker cannot start on database

**Alert ID:** `sql-error-9697-sb-cannot-start-on-database`
**Severity:** 2 Error
**Category:** Service Broker
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.SQL_Server_Service_Broker_cannot_start_on_database_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 9697. Typical message text: "Service Broker cannot start in the specified database."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-9697-database-engine-error
