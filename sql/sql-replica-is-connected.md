# SQL Server — Availability replica is disconnected

**Alert ID:** `sql-replica-is-connected`
**Severity:** 2 Error
**Category:** AlwaysOn
**Detection mechanism:** DMV probe
**Source SCOM monitor / rule (if any):** `Monitor.AvailabilityReplica.IsConnected`

---

## Symptom

The availability replica connection state is disconnected.

## What it means

The local replica cannot communicate with its partner over the database mirroring endpoint. Data movement stops and failover readiness is degraded.
