# SQL Server — SQL error 823 operating system I/O error

**Alert ID:** `sql-error-823-io-logical-error`
**Severity:** 1 Critical
**Category:** Storage
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.OSError_Occurred_While_Performing_IO_onpage_id823`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 823. Typical message text: "The operating system returned error while SQL Server performed read or write at offset in file."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-823-database-engine-error
