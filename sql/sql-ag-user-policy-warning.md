# SQL Server — Availability group user policy warning

**Alert ID:** `sql-ag-user-policy-warning`
**Severity:** 3 Warning
**Category:** AlwaysOn
**Detection mechanism:** DMV probe
**Source SCOM monitor / rule (if any):** `Monitor.AvailabilityGroupWarningPolicy.State`

---

## Symptom

A custom Policy-Based Management policy for the availability group evaluated to warning.

## What it means

The customer-defined AG warning policy has failed. Treat it as an environment-specific compliance signal and inspect the PBM policy text.
