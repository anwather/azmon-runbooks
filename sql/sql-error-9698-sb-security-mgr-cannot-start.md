# SQL Server — SQL error 9698 Service Broker security manager cannot start

**Alert ID:** `sql-error-9698-sb-security-mgr-cannot-start`
**Severity:** 2 Error
**Category:** Service Broker
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.SQL_Server_Service_Broker_security_manager_cannot_start_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 9698. Typical message text: "The Service Broker security manager cannot start."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-9698-database-engine-error
