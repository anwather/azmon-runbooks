# SQL Server — SQL error 3041 backup failed to complete

**Alert ID:** `sql-error-3041-backup-failed`
**Severity:** 2 Error
**Category:** ERRORLOG
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.Database.Database_Backup_Failed_To_Complete_1_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 3041. Typical message text: "BACKUP failed to complete the command. Check the backup application log for detailed messages."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-3041-database-engine-error
