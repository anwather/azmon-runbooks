# SQL Server — Named SQL Server service restarted

**Alert ID:** `sql-engine-service-restart-named-instance`
**Severity:** 1 Critical
**Category:** Engine Service
**Detection mechanism:** DCR-Events XPath
**Source SCOM monitor / rule (if any):** `DBEngine.<service-restart> MSSQL$<instance>`

---

## Symptom

Service Control Manager or SQL provider indicated a named SQL Server service restarted.

## What it means

The named instance restarted. All client connections to that instance were dropped and recovery ran for its databases.
