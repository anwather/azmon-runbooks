# SQL Server — SQL error 33111 TDE certificate failure

**Alert ID:** `sql-error-33111-tde-cert-failure`
**Severity:** 1 Critical
**Category:** Security
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.TDE_certificate_failure_33111_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 33111. Typical message text: "Cannot find server certificate with thumbprint used to encrypt a database encryption key."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-33111-database-engine-error
