# SQL Server — Availability replica role is unhealthy

**Alert ID:** `sql-replica-role-healthy`
**Severity:** 2 Error
**Category:** AlwaysOn
**Detection mechanism:** DMV probe
**Source SCOM monitor / rule (if any):** `Monitor.AvailabilityReplica.RoleIsHealthy`

---

## Symptom

The availability replica role is not a healthy PRIMARY or SECONDARY state.

## What it means

The replica may be resolving after failover, affected by WSFC quorum, or unable to join the AG role.
