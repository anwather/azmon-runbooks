# SQL Server — SQL error 9695 Service Broker task manager memory

**Alert ID:** `sql-error-9695-sb-task-mgr-memory`
**Severity:** 2 Error
**Category:** Service Broker
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.SQL_Server_Service_Broker_task_manager_memory_error_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 9695. Typical message text: "The Service Broker task manager could not allocate required memory."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-9695-database-engine-error
