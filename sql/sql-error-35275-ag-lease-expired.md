# SQL Server — SQL error 35275 AG lease expired

**Alert ID:** `sql-error-35275-ag-lease-expired`
**Severity:** 1 Critical
**Category:** AlwaysOn
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.AvailabilityGroup.LeaseExpired_1_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 35275. Typical message text: "The Always On availability group lease between SQL Server and Windows Server Failover Clustering expired."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-35275-database-engine-error
