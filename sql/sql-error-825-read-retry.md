# SQL Server — SQL error 825 read retry succeeded

**Alert ID:** `sql-error-825-read-retry`
**Severity:** 3 Warning
**Category:** Storage
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.The_IO_operation_was_successful_after_retry_id825`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 825. Typical message text: "A read of the file failed but SQL Server succeeded after retrying the I/O operation."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-825-database-engine-error
