# SQL Server — SQL Agent unable to connect to SQL Server

**Alert ID:** `sql-agent-unable-to-connect`
**Severity:** 1 Critical
**Category:** Agent
**Detection mechanism:** DCR-Events XPath
**Source SCOM monitor / rule (if any):** `CollectionRule.Agent.Unable_to_connect_to_SQL_Server_1_5_Rule`

---

## Symptom

SQL Server Agent is unable to connect to SQL Server.

## What it means

Agent cannot connect to the Database Engine instance it manages. Jobs, alerts, operators, and replication agents cannot be reliably controlled.
...
| where Source has "SQLSERVERAGENT" and EventID == 207
