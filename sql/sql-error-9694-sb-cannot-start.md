# SQL Server — SQL error 9694 Service Broker cannot start

**Alert ID:** `sql-error-9694-sb-cannot-start`
**Severity:** 2 Error
**Category:** Service Broker
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.SQL_Server_Service_Broker_cannot_start_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 9694. Typical message text: "SQL Server Service Broker cannot start."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-9694-database-engine-error
