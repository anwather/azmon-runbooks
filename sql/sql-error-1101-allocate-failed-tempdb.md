# SQL Server — SQL error 1101 could not allocate page

**Alert ID:** `sql-error-1101-allocate-failed-tempdb`
**Severity:** 2 Error
**Category:** Storage
**Detection mechanism:** Custom Text Logs (ERRORLOG) DCR
**Source SCOM monitor / rule (if any):** `EventRule.DBEngine.Could_not_allocate_new_page_for_database_._There_are_no_more_pages_available_in_filegroup.1_5_Rule`

---

## Symptom

The proposed alert fires when SQL ERRORLOG ingestion sees error 1101. Typical message text: "Could not allocate a new page for database because there are no more pages available in filegroup."
...
- Microsoft docs: https://learn.microsoft.com/sql/relational-databases/errors-events/mssqlserver-1101-database-engine-error
